...
import com.tomcatwang.blockchain.block.check.BlockChecker;
...
import com.tomcatwang.blockchain.core.event.DbSyncEvent;
import com.tomcatwang.blockchain.core.manager.DbBlockManager;
import com.tomcatwang.blockchain.core.manager.MessageManager;
import com.tomcatwang.blockchain.core.manager.SyncManager;
...
import com.tomcatwang.blockchain.core.requestbody.InstructionBody;
import com.tomcatwang.blockchain.core.service.BlockService;
import com.tomcatwang.blockchain.core.service.InstructionService;
...
public class BlockController {
    ...
    public BaseData create(@ApiParam(name = "content", value = "区块链内容", required = true)  @RequestParam(value = "content") String content) throws Exception {
        ...
        com.tomcatwang.blockchain.block.BlockBody blockBody = new com.tomcatwang.blockchain.block.BlockBody();
