...
import com.tomcatwang.blockchain.core.bean.Member;
import com.tomcatwang.blockchain.core.bean.MemberData;
import com.tomcatwang.blockchain.core.bean.Permission;
import com.tomcatwang.blockchain.core.bean.PermissionData;
import com.tomcatwang.blockchain.core.event.NodesConnectedEvent;
        ...
        try {
            ...
            if (memberData.getCode() == 0) {
                ...
                for (Member member : memberList) {
                    Node node = new Node(member.getIp(), Integer.parseInt(member.getTioServerPort()));
            ...
            logger.error("请先启动blockchain_manager服务，并配置appId等属性，只有合法联盟链成员才能启动该服务");
            System.exit(0);
        }
